...
class TestSearchHandler(unittest.TestCase):
    def setUp(self):
        ...
        self.app.add_url_rule('/search', 'search_handler', search_handler, methods=['GET'])
    ...
    def test_search_handler_with_results(self, mock_create_connection):
        ...
        mock_create_connection.return_value.__enter__.return_value.cursor.return_value = mock_cursor
